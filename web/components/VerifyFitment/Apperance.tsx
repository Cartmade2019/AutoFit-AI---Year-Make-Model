...
import { CustomSelectBar } from '../Fitment/CustomSelectBar';
import ColorSwatch from '../Fitment/ColorSwatch';
...
export function Apperance({
  ...
  return (
    <>
      <Box padding="400">
        <Checkbox label="Show form title" checked={showHeading} onChange={handleCheckboxChange} />
        ...
        <div style={{ marginTop: '2rem', width: '100%' }}>
          ...
          <div style={{ justifyContent: 'space-between', display: 'flex', gap: '20px' }}>
            ...
            >
              <CustomSelectBar options={[]} value={'2024'} theme="light" />
            ...
            >
              <CustomSelectBar options={[]} value={'2024'} theme="dark" />
